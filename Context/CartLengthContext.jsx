...
export const CartLengthContext = React.createContext({});
...
export const CartLengthProvider = ({ children }) => {
  ...
  return (
    <CartLengthContext.Provider value={{ setCartLength, cartLength }}>
      {children}
    </CartLengthContext.Provider>
  );
};

export const useCart = () => React.useContext(CartLengthContext);
